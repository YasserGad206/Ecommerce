                        ...
                        <div class="col-md-12">
                            ...
                            @endif
                                <div class="card-content collapse show ">
                                    <div class="card-body">
                                        <form class="form" action="{{route('admin.vendor.store')}}" method="POST"
...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyArpObKrSRGjvkaj0Cy6AYlK7Cccrp33uA&libraries=places&callback=initAutocomplete&language=ar&region=sa
     async defer"></script>
@stop