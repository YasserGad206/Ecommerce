                                    ...
                                    <div id="social_block">
                                        <div class="social">
                                            <ul class="list-inline mb-0 justify-content-end">
                                                <li class="list-inline-item mb-0"><a href="https://www.facebook.com/yasser.esam.7" target="_blank"><i class="zmdi zmdi-facebook"></i></a></li>
                                ...
                                <div class="block_content">
                                    ...
                                    <div class="data-contact d-flex align-self-stretch">
                                        ...
                                        <div class="content-data-contact">
                                            ...
                                            <div class="phone-support">0565589747</div>
                                        </div>
                                    </div>
                                    <div class="data-contact d-flex align-self-stretch">
                                        ...
                                        <div class="content-data-contact">
                                            ...
                                            <div class="content-info-contact">الرياض  <br /> المملكة العربية السعودية</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 align-items-center justify-content-md-start justify-content-sm-center d-flex pb-xs-max-20 flex-center">
                    <span>
            Copyright © 2018 yasseresam. All Rights Reserved
          </span>
                </div>
